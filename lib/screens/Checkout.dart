...
String totalPrice()
{
  int xx=int.parse(pricex) + int.parse("30") + int.parse("20");
  x=xx*100;
  return xx.toString();
}
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Expanded(
                                  child: Text("Delivery Charges", style: TextStyle(fontSize: 15, color: Colors.grey),)
                              ),
                              Text("Rs 30", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Expanded(
                                  child: Text("GST Charges", style: TextStyle(fontSize: 15, color: Colors.grey),)
                              ),
                              Text("Rs 20", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ),
                        Padding(
